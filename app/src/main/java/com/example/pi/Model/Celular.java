...
public class Celular {
    ...
    public Celular(int IDMODELO_CELULAR, int TELA_IDTELA, int PROCESSADOR_IDPROCESSADOR, int MARCA_CELULAR_IDMARCA_CELULAR, int SISTEMA_OPERACIONAL_IDSISTEMA_OPERACIONAL, int CAMERA_IDCAMERA, String MODELO_CELULAR, int MEMORIA_RAM, int MEMORIA, int PRECO) {
